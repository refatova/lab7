 ...
 */
public class GreetingService extends RemoteServiceServlet implements GreetingMessageIntf {
    ...
    final static Logger log = LogManager.getLogger(GreetingService.class.getName());
